...
class AWSProvider:
    ...
    def __init__(self, region: str | None = None) -> None:
        ...
        # Keep the boto3 session dynamic so mypy does not require
        # service_name to be one of boto3-stubs' Literal overloads.
        self.session: Any = boto3.session.Session(region_name=self.region)
